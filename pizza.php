...
<body>
	...
	<form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
		...
		<input type="submit" value="피자 만들기">
	</form>
	<?php
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		// SQL 쿼리 실행
		$sql = "INSERT INTO pizza (source1, source2,source3,source4,source5,percent1,percent2,percent3,percent4,percent5,name) VALUES ('$source1', '$source2','$source3','$source4','$source5','$percent1','$percent2','$percent3','$percent4','$percent5','$name')";
		if ($conn->query($sql) === TRUE) {
			...
			echo '<div id="pizzachart" style="width: 900px; height: 500px;">';
			...
			echo 'var options = {';
			echo "title: '당신이 만든 피자, $name',";
			echo 'pieHole: 0.4,';
			echo '};';
		
			echo 'var chart = new google.visualization.PieChart(document.getElementById("pizzachart"));';
